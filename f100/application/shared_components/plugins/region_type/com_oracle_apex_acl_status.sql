...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(14863508483182802394)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(53500003343803735)
,p_plugin_id=>wwv_flow_imp.id(14863508483182802394)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(53500430068803736)
,p_plugin_id=>wwv_flow_imp.id(14863508483182802394)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(53500749842803736)
,p_plugin_id=>wwv_flow_imp.id(14863508483182802394)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(53501231495803737)
,p_plugin_id=>wwv_flow_imp.id(14863508483182802394)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(53501628190803737)
,p_plugin_id=>wwv_flow_imp.id(14863508483182802394)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(53501941662803737)
,p_plugin_id=>wwv_flow_imp.id(14863508483182802394)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(53502351692803738)
,p_plugin_id=>wwv_flow_imp.id(14863508483182802394)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_std_attribute(
 p_id=>wwv_flow_imp.id(53503414624803744)
,p_plugin_id=>wwv_flow_imp.id(14863508483182802394)
,p_name=>'SOURCE_SQL'
