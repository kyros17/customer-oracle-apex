...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(14863511521478802399)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(53505132101806181)
,p_plugin_id=>wwv_flow_imp.id(14863511521478802399)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(53505535395806181)
,p_plugin_id=>wwv_flow_imp.id(14863511521478802399)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(53505898303806181)
,p_plugin_id=>wwv_flow_imp.id(14863511521478802399)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(53506308793806181)
,p_plugin_id=>wwv_flow_imp.id(14863511521478802399)
,p_attribute_scope=>'COMPONENT'
