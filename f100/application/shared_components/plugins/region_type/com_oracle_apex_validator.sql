...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(14935257921041930813)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(15699012878883851931)
,p_plugin_id=>wwv_flow_imp.id(14935257921041930813)
...
wwv_flow_imp_shared.create_plugin_std_attribute(
 p_id=>wwv_flow_imp.id(1058339618304677160)
,p_plugin_id=>wwv_flow_imp.id(14935257921041930813)
,p_name=>'SOURCE_SQL'
,p_is_required=>false
...
wwv_flow_imp_shared.create_plugin_file(
 p_id=>wwv_flow_imp.id(15699013958733851932)
,p_plugin_id=>wwv_flow_imp.id(14935257921041930813)
