...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(18714885067857949895)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(657638462149654281)
,p_plugin_id=>wwv_flow_imp.id(18714885067857949895)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(657638883036654281)
,p_plugin_id=>wwv_flow_imp.id(18714885067857949895)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(657639270131654281)
,p_plugin_id=>wwv_flow_imp.id(18714885067857949895)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_std_attribute(
 p_id=>wwv_flow_imp.id(657641490508654284)
,p_plugin_id=>wwv_flow_imp.id(18714885067857949895)
,p_name=>'SOURCE_SQL'
,p_is_required=>false
...
wwv_flow_imp_shared.create_plugin_file(
 p_id=>wwv_flow_imp.id(657642144229654285)
,p_plugin_id=>wwv_flow_imp.id(18714885067857949895)
