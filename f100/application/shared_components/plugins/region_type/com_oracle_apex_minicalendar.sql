...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(14876049246355464404)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(165431075733077592)
,p_plugin_id=>wwv_flow_imp.id(14876049246355464404)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(165431448897077600)
,p_plugin_id=>wwv_flow_imp.id(14876049246355464404)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_std_attribute(
 p_id=>wwv_flow_imp.id(165432688360077634)
,p_plugin_id=>wwv_flow_imp.id(14876049246355464404)
,p_name=>'SOURCE_SQL'
...
wwv_flow_imp_shared.create_plugin_file(
 p_id=>wwv_flow_imp.id(165433366707077640)
,p_plugin_id=>wwv_flow_imp.id(14876049246355464404)
