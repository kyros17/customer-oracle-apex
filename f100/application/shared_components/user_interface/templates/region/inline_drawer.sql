...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(304109773638964273)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(691612318402435490)
,p_plug_template_id=>wwv_flow_imp.id(304109773638964273)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(691612757447435491)
,p_plug_template_id=>wwv_flow_imp.id(304109773638964273)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(691613290595435491)
,p_plug_template_id=>wwv_flow_imp.id(304109773638964273)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(691613825521435491)
,p_plug_template_id=>wwv_flow_imp.id(304109773638964273)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(691614289905435492)
,p_plug_template_id=>wwv_flow_imp.id(304109773638964273)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(691614764698435492)
,p_plug_template_id=>wwv_flow_imp.id(304109773638964273)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(691615327770435493)
,p_plug_template_id=>wwv_flow_imp.id(304109773638964273)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(691615769607435493)
,p_plug_template_id=>wwv_flow_imp.id(304109773638964273)
,p_name=>'Sub Regions'
