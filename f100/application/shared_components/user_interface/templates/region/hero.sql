...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(14860534086332969952)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(691578337661435456)
,p_plug_template_id=>wwv_flow_imp.id(14860534086332969952)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(691578796153435456)
,p_plug_template_id=>wwv_flow_imp.id(14860534086332969952)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(691579293471435456)
,p_plug_template_id=>wwv_flow_imp.id(14860534086332969952)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(691579784827435457)
,p_plug_template_id=>wwv_flow_imp.id(14860534086332969952)
,p_name=>'Sub Regions'
