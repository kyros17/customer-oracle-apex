...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(14860534668738969954)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(691542009590435418)
,p_plug_template_id=>wwv_flow_imp.id(14860534668738969954)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(691542463390435418)
,p_plug_template_id=>wwv_flow_imp.id(14860534668738969954)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(691542954900435419)
,p_plug_template_id=>wwv_flow_imp.id(14860534668738969954)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(691543516409435419)
,p_plug_template_id=>wwv_flow_imp.id(14860534668738969954)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(691543990847435419)
,p_plug_template_id=>wwv_flow_imp.id(14860534668738969954)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(691544512177435420)
,p_plug_template_id=>wwv_flow_imp.id(14860534668738969954)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(691544954012435420)
,p_plug_template_id=>wwv_flow_imp.id(14860534668738969954)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(691545472485435421)
,p_plug_template_id=>wwv_flow_imp.id(14860534668738969954)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(691545999504435421)
,p_plug_template_id=>wwv_flow_imp.id(14860534668738969954)
,p_name=>'Sub Regions'
