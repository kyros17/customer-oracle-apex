...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(691700528531435573)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(691700979024435575)
,p_plug_template_id=>wwv_flow_imp.id(691700528531435573)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(691701494586435575)
,p_plug_template_id=>wwv_flow_imp.id(691700528531435573)
,p_name=>'Search Field'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(691701975395435576)
,p_plug_template_id=>wwv_flow_imp.id(691700528531435573)
,p_name=>'Sub Regions'
