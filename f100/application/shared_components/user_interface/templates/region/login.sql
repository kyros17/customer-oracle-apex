...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(14860537626591969959)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(691642858123435519)
,p_plug_template_id=>wwv_flow_imp.id(14860537626591969959)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(691643358803435519)
,p_plug_template_id=>wwv_flow_imp.id(14860537626591969959)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(691643894183435519)
,p_plug_template_id=>wwv_flow_imp.id(14860537626591969959)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(691644405354435520)
,p_plug_template_id=>wwv_flow_imp.id(14860537626591969959)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(691644905121435520)
,p_plug_template_id=>wwv_flow_imp.id(14860537626591969959)
,p_name=>'Sub Regions'
