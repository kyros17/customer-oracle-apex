...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(697399840425712229)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(691510221573435387)
,p_plug_template_id=>wwv_flow_imp.id(697399840425712229)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(691510734604435388)
,p_plug_template_id=>wwv_flow_imp.id(697399840425712229)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(691511207755435388)
,p_plug_template_id=>wwv_flow_imp.id(697399840425712229)
,p_name=>'Sub Regions'
