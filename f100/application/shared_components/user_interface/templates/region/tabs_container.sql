...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(15237065361251027426)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(691676479003435551)
,p_plug_template_id=>wwv_flow_imp.id(15237065361251027426)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(691676948396435551)
,p_plug_template_id=>wwv_flow_imp.id(15237065361251027426)
,p_name=>'Tabs'
