...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(519230700063450487)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(691585292293435464)
,p_plug_template_id=>wwv_flow_imp.id(519230700063450487)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(691585837964435464)
,p_plug_template_id=>wwv_flow_imp.id(519230700063450487)
,p_name=>'Sub Regions'
