...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(691704748644435579)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(691705246470435579)
,p_plug_template_id=>wwv_flow_imp.id(691704748644435579)
,p_name=>'Item'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(691705753820435580)
,p_plug_template_id=>wwv_flow_imp.id(691704748644435579)
,p_name=>'Button End'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(691706239605435580)
,p_plug_template_id=>wwv_flow_imp.id(691704748644435579)
,p_name=>'Button Start'
