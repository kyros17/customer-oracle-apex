...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(303913433487964613)
,p_theme_id=>42
,p_name=>'Drawer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(691395344779435268)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(691395857583435269)
,p_page_template_id=>wwv_flow_imp.id(303913433487964613)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(691396366067435270)
,p_page_template_id=>wwv_flow_imp.id(303913433487964613)
