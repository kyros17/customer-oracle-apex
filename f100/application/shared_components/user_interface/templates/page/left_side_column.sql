...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(14860497211121969901)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(691405538010435285)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(691406001066435285)
,p_page_template_id=>wwv_flow_imp.id(14860497211121969901)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(691406532557435286)
,p_page_template_id=>wwv_flow_imp.id(14860497211121969901)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(691406990053435286)
,p_page_template_id=>wwv_flow_imp.id(14860497211121969901)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(691407481128435286)
,p_page_template_id=>wwv_flow_imp.id(14860497211121969901)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(691408014625435287)
,p_page_template_id=>wwv_flow_imp.id(14860497211121969901)
,p_name=>'Left Column'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(691408470376435287)
,p_page_template_id=>wwv_flow_imp.id(14860497211121969901)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(691408952018435287)
,p_page_template_id=>wwv_flow_imp.id(14860497211121969901)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(691409507420435288)
,p_page_template_id=>wwv_flow_imp.id(14860497211121969901)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(691410011292435288)
,p_page_template_id=>wwv_flow_imp.id(14860497211121969901)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(691410500483435288)
,p_page_template_id=>wwv_flow_imp.id(14860497211121969901)
