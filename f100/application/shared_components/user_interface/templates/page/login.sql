...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(14860503834372969909)
,p_theme_id=>42
,p_name=>'Login'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(691424590192435302)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(691425090473435302)
,p_page_template_id=>wwv_flow_imp.id(14860503834372969909)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(691425560963435302)
,p_page_template_id=>wwv_flow_imp.id(14860503834372969909)
,p_name=>'Body Header'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(691426068756435303)
,p_page_template_id=>wwv_flow_imp.id(14860503834372969909)
,p_name=>'Body Footer'
