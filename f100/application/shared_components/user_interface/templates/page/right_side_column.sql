...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(14860517755802969927)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(691458230214435331)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(691458660814435332)
,p_page_template_id=>wwv_flow_imp.id(14860517755802969927)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(691459235274435332)
,p_page_template_id=>wwv_flow_imp.id(14860517755802969927)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(691459645845435333)
,p_page_template_id=>wwv_flow_imp.id(14860517755802969927)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(691460146699435333)
,p_page_template_id=>wwv_flow_imp.id(14860517755802969927)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(691460641745435334)
,p_page_template_id=>wwv_flow_imp.id(14860517755802969927)
,p_name=>'Right Column'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(691461161978435334)
,p_page_template_id=>wwv_flow_imp.id(14860517755802969927)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(691461661093435334)
,p_page_template_id=>wwv_flow_imp.id(14860517755802969927)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(691462213776435335)
,p_page_template_id=>wwv_flow_imp.id(14860517755802969927)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(691462669453435335)
,p_page_template_id=>wwv_flow_imp.id(14860517755802969927)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(691463163116435335)
,p_page_template_id=>wwv_flow_imp.id(14860517755802969927)
