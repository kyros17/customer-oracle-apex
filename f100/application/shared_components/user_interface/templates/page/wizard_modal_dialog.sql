...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(14860520857153969930)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(691475091973435345)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(691475623556435345)
,p_page_template_id=>wwv_flow_imp.id(14860520857153969930)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(691476044734435345)
,p_page_template_id=>wwv_flow_imp.id(14860520857153969930)
