...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(14860510867740969917)
,p_theme_id=>42
,p_name=>'Modal Dialog'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(691451364380435326)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(691451849056435326)
,p_page_template_id=>wwv_flow_imp.id(14860510867740969917)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(691452429665435327)
,p_page_template_id=>wwv_flow_imp.id(14860510867740969917)
