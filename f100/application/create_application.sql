...
,p_name=>nvl(wwv_flow_application_install.get_application_name,'Customers izr')
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'CUSTOMERS')
,p_application_group=>wwv_flow_imp.id(165424530857721532)
...
,p_authentication_id=>wwv_flow_imp.id(17801591699274418067)
...
,p_security_scheme=>wwv_flow_imp.id(15967938544128469092)
...
,p_last_upd_yyyymmddhh24miss=>'20230221104234'
