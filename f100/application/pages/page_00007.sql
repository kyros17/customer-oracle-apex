...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(16635395614807803748)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(16635398222328803756)
,p_plug_name=>'Audit Information'
,p_parent_plug_id=>wwv_flow_imp.id(16635395614807803748)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(16635400425117803758)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(16635395825709803750)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(16635400425117803758)
,p_button_name=>'SAVE'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(16635396015568803751)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(16635396430727803751)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(16635402043996803770)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(16635396621405803751)
,p_name=>'P7_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(16635395614807803748)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(16635396841899803754)
,p_name=>'P7_NOTE'
,p_is_required=>true
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(16635395614807803748)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(16635397323845803754)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(16635397814706803754)
,p_name=>'P7_NOTE_DATE'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_imp.id(16635395614807803748)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(16635398423812803756)
,p_name=>'P7_CREATED'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_imp.id(16635398222328803756)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(16635398924400803756)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(16635399437832803758)
,p_name=>'P7_UPDATED'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_imp.id(16635398222328803756)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(16635399926156803758)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(16635403034391844398)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(16635408222822105998)
,p_name=>'P7_SS'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(16635395614807803748)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(16635401128487803767)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(16635401336441803768)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(16635401527391803768)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_SESSION_STATE'
,p_process_name=>'reset page'
,p_attribute_01=>'CLEAR_CACHE_CURRENT_PAGE'
,p_process_when_button_id=>wwv_flow_imp.id(16635396430727803751)
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(16635401730132803769)
