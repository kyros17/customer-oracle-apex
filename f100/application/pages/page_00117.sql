...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(17951000526281566321)
,p_plug_name=>'Filters'
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(17951001797909566332)
,p_name=>'Change Log'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(17951002226294566339)
,p_query_column_id=>1
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(17951002663280566343)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(17951003075356566348)
,p_query_column_id=>3
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(17951003486282566349)
,p_query_column_id=>4
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(17951003896342566351)
,p_query_column_id=>5
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(17951004286890566352)
,p_query_column_id=>6
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(17951014629201566354)
,p_query_column_id=>7
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(17951015012291566355)
,p_query_column_id=>8
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(17951015421076566356)
,p_query_column_id=>9
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(17951015831841566357)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(17951016267256566359)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(17951016589445566360)
...
,p_heading_alignment=>'LEFT'
,p_report_column_required_role=>wwv_flow_imp.id(15677026128353929641)
,p_derived_column=>'N'
,p_include_in_export=>'N'
);
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(17951016941443566363)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(17951017312171566364)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(17951001331625566329)
,p_name=>'P117_SHOW_VIEWS'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(17951000526281566321)
,p_display_as=>'NATIVE_CHECKBOX'
,p_named_lov=>'SHOW CUSTOMER VIEWS CHECKBOX'
,p_lov=>'.'||wwv_flow_imp.id(17951021494227566392)||'.'
,p_cSize=>30
,p_cHeight=>1
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(17951017758492566366)
,p_name=>'P117_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(17951001797909566332)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(17951020012584566385)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(17951020534470566387)
,p_event_id=>wwv_flow_imp.id(17951020012584566385)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(17951021051495566388)
,p_event_id=>wwv_flow_imp.id(17951020012584566385)
,p_event_result=>'TRUE'
...
,p_affected_region_id=>wwv_flow_imp.id(17951001797909566332)
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(17951018201070566380)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(17951018670152566383)
,p_event_id=>wwv_flow_imp.id(17951018201070566380)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(17951019198663566384)
,p_event_id=>wwv_flow_imp.id(17951018201070566380)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(17951019621110566385)
,p_event_id=>wwv_flow_imp.id(17951018201070566380)
,p_event_result=>'TRUE'
