...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(13528075846147960616)
,p_plug_name=>'Buttons'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(16595417628736712323)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(16595417846348712325)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(13528075846147960616)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(16595417928753712325)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(16595418233306712326)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(16595418037445712325)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(14722799735214591541)
,p_name=>'P37_CUSTOMER_LINK'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(16595417628736712323)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(14722804624394642132)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(16595419027906712332)
,p_name=>'P37_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(16595417628736712323)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(16595419221529712359)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(16595419427714712360)
,p_name=>'P37_NAME'
,p_is_required=>true
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_imp.id(16595417628736712323)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(16595419643138712360)
,p_name=>'P37_TITLE'
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_imp.id(16595417628736712323)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(16595419818195712360)
,p_name=>'P37_COMPANY'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_imp.id(16595417628736712323)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(16595420024502712360)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(16595420230295712360)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(16595420440192712360)
,p_name=>'P37_CITY'
,p_item_sequence=>160
,p_item_plug_id=>wwv_flow_imp.id(16595417628736712323)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(16595420621291712361)
,p_name=>'P37_STATE'
,p_item_sequence=>170
,p_item_plug_id=>wwv_flow_imp.id(16595417628736712323)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(16595420837891712361)
,p_name=>'P37_COUNTRY'
,p_item_sequence=>190
,p_item_plug_id=>wwv_flow_imp.id(16595417628736712323)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(16595421046614712361)
,p_name=>'P37_ZIP'
,p_item_sequence=>200
,p_item_plug_id=>wwv_flow_imp.id(16595417628736712323)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(16595421241499712361)
,p_name=>'P37_EMAIL'
,p_item_sequence=>220
,p_item_plug_id=>wwv_flow_imp.id(16595417628736712323)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(16595421414545712361)
,p_name=>'P37_PHONE'
,p_item_sequence=>290
,p_item_plug_id=>wwv_flow_imp.id(16595417628736712323)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(16595421644904712362)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(16595421834023712362)
,p_name=>'P37_FAX'
,p_item_sequence=>310
,p_item_plug_id=>wwv_flow_imp.id(16595417628736712323)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(16595422025884712362)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(16595422220372712362)
,p_name=>'P37_NOTES'
,p_item_sequence=>340
,p_item_plug_id=>wwv_flow_imp.id(16595417628736712323)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(16595422433260712362)
,p_name=>'P37_TAGS'
,p_item_sequence=>360
,p_item_plug_id=>wwv_flow_imp.id(16595417628736712323)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(13846923761897807793)
,p_name=>'cancel dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(16595418233306712326)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(13846923831674807794)
,p_event_id=>wwv_flow_imp.id(13846923761897807793)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(16595424526541712365)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(16595424746768712366)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(16595424940060712366)
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(16595418037445712325)
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(13528075921810960617)
