...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1107260115383513359)
...
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(1107260299411513360)
,p_region_id=>wwv_flow_imp.id(1107260115383513359)
,p_chart_type=>'bar'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(1107260317429513361)
,p_chart_id=>wwv_flow_imp.id(1107260299411513360)
,p_seq=>10
,p_name=>'Category'
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(1107260517512513363)
,p_chart_id=>wwv_flow_imp.id(1107260299411513360)
,p_axis=>'y'
,p_is_rendered=>'on'
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(1107260494259513362)
,p_chart_id=>wwv_flow_imp.id(1107260299411513360)
,p_axis=>'x'
,p_is_rendered=>'on'
,p_format_scaling=>'auto'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(15772285435547463921)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(15871382254780990154)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(15875266663220932641)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(15772285435547463921)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(15871382530723990155)
,p_name=>'P32_CATEGORY'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(15871382254780990154)
,p_item_default=>'0'
,p_prompt=>'Category'
,p_source=>'0'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(15875267373874938804)
,p_name=>'P32_GEO'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(15871382254780990154)
,p_prompt=>'Geography'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(15871387541229011215)
,p_name=>'set cat'
,p_event_sequence=>10
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1107260661531513364)
,p_event_id=>wwv_flow_imp.id(15871387541229011215)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(1107260115383513359)
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(15875267851012945378)
,p_name=>'geo'
,p_event_sequence=>20
,p_triggering_element_type=>'ITEM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1107260776248513365)
,p_event_id=>wwv_flow_imp.id(15875267851012945378)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
