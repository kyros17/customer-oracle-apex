...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(15889027526569210266)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(15889027936298210269)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(15889028027502210270)
,p_plug_name=>'Data Load Source'
,p_parent_plug_id=>wwv_flow_imp.id(15889027936298210269)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(15889031445421210282)
,p_plug_name=>'Globalization'
,p_parent_plug_id=>wwv_flow_imp.id(15889028027502210270)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(16665771345795176343)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(16665771630343181299)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(15889027526569210266)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(15889028422941210274)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(15889027936298210269)
,p_button_name=>'NEXT'
,p_button_action=>'DEFINED_BY_DA'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(15889028333754210272)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(15889027936298210269)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(15889034629116210288)
,p_branch_action=>'f?p=&APP_ID.:61:&SESSION.&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(15889028422941210274)
,p_branch_sequence=>10
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(15889028737630210276)
,p_name=>'P60_IMPORT_FROM'
,p_is_required=>true
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(15889028027502210270)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(15889028846307210276)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(15889029626822210279)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(15889030136803210280)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(15889030631386210282)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(15889031139442210282)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(15889031221879210282)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(15889031720971210283)
,p_name=>'P60_CURRENCY'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_imp.id(15889031445421210282)
,p_item_default=>'$'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(15889032245413210284)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(15889032732222210284)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(16665772043849185208)
,p_name=>'P60_SAMPLE_DATA'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(16665771345795176343)
,p_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(17923927686040560333)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(15889029434381210278)
...
,p_when_button_pressed=>wwv_flow_imp.id(15889028422941210274)
,p_associated_item=>wwv_flow_imp.id(15889028846307210276)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(17923927376921560330)
...
,p_validation_condition_type=>'VAL_OF_ITEM_IN_COND_EQ_COND2'
,p_when_button_pressed=>wwv_flow_imp.id(15889028422941210274)
,p_associated_item=>wwv_flow_imp.id(15889031221879210282)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(15889033124466210284)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(15889033434976210285)
,p_event_id=>wwv_flow_imp.id(15889033124466210284)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(15889033628709210286)
,p_event_id=>wwv_flow_imp.id(15889033124466210284)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(15889033718481210286)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(15889034040546210286)
,p_event_id=>wwv_flow_imp.id(15889033718481210286)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SHOW'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(15889034245099210286)
,p_event_id=>wwv_flow_imp.id(15889033718481210286)
,p_event_result=>'FALSE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(17923926814367560325)
,p_name=>'Set copy and paste textarea with sample data'
,p_event_sequence=>30
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(16665771630343181299)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(17923927574490560332)
,p_event_id=>wwv_flow_imp.id(17923926814367560325)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(17923926918705560326)
,p_event_id=>wwv_flow_imp.id(17923926814367560325)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(17923927249787560329)
,p_event_id=>wwv_flow_imp.id(17923926814367560325)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(17923927087533560327)
,p_event_id=>wwv_flow_imp.id(17923926814367560325)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1308353569242340777)
,p_event_id=>wwv_flow_imp.id(17923926814367560325)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(17923927145574560328)
,p_event_id=>wwv_flow_imp.id(17923926814367560325)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(18146864433747088188)
,p_name=>'Set orig cut paste value and submit'
,p_event_sequence=>40
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(15889028422941210274)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(18146864554879088189)
,p_event_id=>wwv_flow_imp.id(18146864433747088188)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(18146864632112088190)
,p_event_id=>wwv_flow_imp.id(18146864433747088188)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(18146864800229088191)
,p_event_id=>wwv_flow_imp.id(18146864433747088188)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(18146866759543088211)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(18146866847871088212)
,p_event_id=>wwv_flow_imp.id(18146866759543088211)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(15889034445185210288)
...
,p_process_when_button_id=>wwv_flow_imp.id(15889028422941210274)
);
