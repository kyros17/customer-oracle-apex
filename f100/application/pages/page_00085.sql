...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1107260834657513366)
...
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(1107260988875513367)
,p_region_id=>wwv_flow_imp.id(1107260834657513366)
,p_chart_type=>'bar'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(1107261028737513368)
,p_chart_id=>wwv_flow_imp.id(1107260988875513367)
,p_seq=>10
,p_name=>'Geography'
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(1107261134549513369)
,p_chart_id=>wwv_flow_imp.id(1107260988875513367)
,p_axis=>'x'
,p_is_rendered=>'on'
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(1107261278970513370)
,p_chart_id=>wwv_flow_imp.id(1107260988875513367)
,p_axis=>'y'
,p_is_rendered=>'on'
,p_format_scaling=>'auto'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(15772290855111513645)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(15871386065167003059)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(15875266302929930093)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(15772290855111513645)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(15871386331963003060)
,p_name=>'P85_CATEGORY'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(15871386065167003059)
,p_item_default=>'0'
,p_prompt=>'Category'
,p_source=>'0'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(15871531232805124294)
,p_name=>'set cat'
,p_event_sequence=>10
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1107261395583513371)
,p_event_id=>wwv_flow_imp.id(15871531232805124294)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(1107260834657513366)
);
