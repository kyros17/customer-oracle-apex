...
,p_step_template=>wwv_flow_imp.id(15022497101664306621)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3137611530008228481)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3137611400075228480)
,p_plug_name=>'Welcome to &APPLICATION_TITLE.'
,p_parent_plug_id=>wwv_flow_imp.id(3137611530008228481)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3137611576472228482)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3137613752037228503)
,p_plug_name=>'ACL Level'
,p_parent_plug_id=>wwv_flow_imp.id(3137611576472228482)
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(14860524085240969937)
,p_plug_display_sequence=>10
,p_plug_display_point=>'SUB_REGIONS'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3137611720290228483)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3137611837409228484)
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(3137614209882228508)
,p_name=>'Feature Configuration'
,p_parent_plug_id=>wwv_flow_imp.id(3137611837409228484)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1165252049271781328)
,p_query_column_id=>1
,p_column_alias=>'ID'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1165252419136781328)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1165252811212781329)
,p_query_column_id=>3
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1165253244012781329)
,p_query_column_id=>4
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1165253622749781329)
,p_query_column_id=>5
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1165254074214781330)
,p_query_column_id=>6
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1165254446592781330)
,p_query_column_id=>7
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3137615124441228517)
,p_plug_name=>'Users'
,p_region_css_classes=>'step-container'
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(3137612376641228490)
,p_name=>'Users'
,p_parent_plug_id=>wwv_flow_imp.id(3137615124441228517)
,p_template=>wwv_flow_imp.id(14860524085240969937)
,p_display_sequence=>10
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1165248639799781324)
,p_query_column_id=>1
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1165247870150781323)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1165247446752781323)
,p_query_column_id=>3
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1165246250517781322)
,p_query_column_id=>4
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1361516688709436663)
,p_query_column_id=>5
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1165248225124781324)
,p_query_column_id=>6
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1165246643665781322)
,p_query_column_id=>7
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1165247033493781323)
,p_query_column_id=>8
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3137615204695228518)
,p_plug_name=>'Buttons'
,p_region_css_classes=>'step-container'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3148942494238488078)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1165249786490781325)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3137615204695228518)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1165255164679781331)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3148942494238488078)
,p_button_name=>'OK'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1165249014953781324)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3137612376641228490)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1165245214916781320)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1165251061256781327)
,p_name=>'P1000_LOAD_SAMPLE_YN'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(3137611720290228483)
,p_item_default=>'Y'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(1165257517487781333)
,p_name=>'Refresh Users Region on Modal Close'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(930055145582807573)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1165258063055781335)
,p_event_id=>wwv_flow_imp.id(1165257517487781333)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(3137612376641228490)
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(1165258411879781335)
,p_name=>'Refresh on edit'
,p_event_sequence=>20
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(3137612376641228490)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1165258927847781335)
,p_event_id=>wwv_flow_imp.id(1165258411879781335)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(1165256731431781332)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(1165255519048781331)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(1165255992106781332)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(1165256356565781332)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(1165257208060781333)
,p_process_sequence=>10
...
,p_process_clob_language=>'PLSQL'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(1165249786490781325)
