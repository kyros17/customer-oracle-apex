...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(15890067123622388992)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(15387212299779496446)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(15890067123622388992)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(15387211487033496445)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(15387211157510496445)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(15387211940850496445)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(15387214990473496455)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(335550166441469183)
,p_name=>'CNX'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(15387212299779496446)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(335550260794469184)
,p_event_id=>wwv_flow_imp.id(335550166441469183)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(15387213747119496453)
...
,p_process_when_button_id=>wwv_flow_imp.id(15387211940850496445)
,p_process_success_message=>'Sample data reset.'
,p_security_scheme=>wwv_flow_imp.id(15677026128353929641)
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(15387214111516496455)
...
,p_process_clob_language=>'PLSQL'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(15387211487033496445)
,p_process_success_message=>'Sample Data Removed'
,p_security_scheme=>wwv_flow_imp.id(15677026128353929641)
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(15387214525385496455)
...
,p_process_clob_language=>'PLSQL'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(15387211157510496445)
