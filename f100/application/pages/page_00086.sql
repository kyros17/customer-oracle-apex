...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1098962120207429994)
...
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(1098962248267429995)
,p_region_id=>wwv_flow_imp.id(1098962120207429994)
,p_chart_type=>'bar'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(1322637287911434346)
,p_chart_id=>wwv_flow_imp.id(1098962248267429995)
,p_seq=>10
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(1322637340325434347)
,p_chart_id=>wwv_flow_imp.id(1098962248267429995)
,p_axis=>'x'
,p_is_rendered=>'on'
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(1322637433243434348)
,p_chart_id=>wwv_flow_imp.id(1098962248267429995)
,p_axis=>'y'
,p_is_rendered=>'on'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1322637603530434349)
...
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(1322637623916434350)
,p_region_id=>wwv_flow_imp.id(1322637603530434349)
,p_chart_type=>'bar'
,p_animation_on_display=>'auto'
,p_animation_on_data_change=>'auto'
,p_orientation=>'vertical'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(1322637757606434351)
,p_chart_id=>wwv_flow_imp.id(1322637623916434350)
,p_seq=>10
,p_name=>'Asset Commitment'
,p_data_source_type=>'SQL'
,p_data_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(1322637932680434353)
,p_chart_id=>wwv_flow_imp.id(1322637623916434350)
,p_axis=>'y'
,p_is_rendered=>'on'
,p_format_type=>'decimal'
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(1322637892825434352)
,p_chart_id=>wwv_flow_imp.id(1322637623916434350)
,p_axis=>'x'
,p_is_rendered=>'on'
,p_format_scaling=>'auto'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(15773205754715623915)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(15773263892816768315)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(15773264726564769499)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(15773436237390950992)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(15845845626988798267)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(15773280931630821586)
,p_button_sequence=>1000
,p_button_plug_id=>wwv_flow_imp.id(15773205754715623915)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(15773265010754769500)
,p_name=>'P86_CATEGORY'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(15773264726564769499)
,p_item_default=>'0'
,p_prompt=>'Category'
,p_source=>'0'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(15875258558327837925)
,p_name=>'P86_GEO'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(15773264726564769499)
,p_prompt=>'Geography'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(15875261346196895401)
,p_name=>'cat'
,p_event_sequence=>10
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(15875262652681898100)
,p_event_id=>wwv_flow_imp.id(15875261346196895401)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(15845845626988798267)
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(15875265009215908955)
,p_event_id=>wwv_flow_imp.id(15875261346196895401)
,p_event_result=>'TRUE'
...
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(15773263892816768315)
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(15875262949038902462)
,p_name=>'geo'
,p_event_sequence=>20
,p_triggering_element_type=>'ITEM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(15875264269851905238)
,p_event_id=>wwv_flow_imp.id(15875262949038902462)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(15875264666258906843)
,p_event_id=>wwv_flow_imp.id(15875262949038902462)
,p_event_result=>'TRUE'
,p_action_sequence=>40
,p_execute_on_page_init=>'N'
