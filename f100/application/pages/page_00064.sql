...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(13528075708399960615)
,p_plug_name=>'Buttons'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(16591377845879442324)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(16591389725021503210)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(16591378039597442328)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(13528075708399960615)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(16591378131199442328)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(16591378230561442328)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(16591378435761442328)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(14722812120882719753)
,p_name=>'P64_CUSTOMER_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(16591377845879442324)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(14722812846749722954)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(16591379246524442336)
,p_name=>'P64_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(16591377845879442324)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(16591379646545442348)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(16591379814137442348)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(16591380243882442350)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(16591380423311442350)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(16591380644806442350)
,p_name=>'P64_TAGS'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_imp.id(16591377845879442324)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_computation(
 p_id=>wwv_flow_imp.id(14937705535833268360)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(14279149678707869620)
,p_validation_name=>'File must be uploaded on add'
,p_validation_sequence=>10
,p_validation=>'P64_FILE_BLOB'
,p_validation_type=>'ITEM_NOT_NULL'
,p_error_message=>'#LABEL# must have some value.'
,p_when_button_pressed=>wwv_flow_imp.id(16591378039597442328)
,p_associated_item=>wwv_flow_imp.id(16591380243882442350)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(13846923203121807787)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(16591378435761442328)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(13846923231791807788)
,p_event_id=>wwv_flow_imp.id(13846923203121807787)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(16591381721094442352)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(16591381915615442352)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(16591382116597442352)
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(16591378230561442328)
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(13528076056897960618)
