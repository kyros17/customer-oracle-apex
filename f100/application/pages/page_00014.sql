...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(15069276329144197770)
,p_plug_name=>'Buttons'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(15069276821731200477)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(15069277730847214946)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(15069276329144197770)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(15069277520503214944)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(15069278143350219491)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(15069277126541212152)
,p_name=>'P14_WELCOME_TEXT'
,p_is_required=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(15069276821731200477)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(335550564157469187)
,p_name=>'CNX'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(15069277520503214944)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(335550642521469188)
,p_event_id=>wwv_flow_imp.id(335550564157469187)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(15069278239440233986)
...
,p_process_when_button_id=>wwv_flow_imp.id(15069277730847214946)
