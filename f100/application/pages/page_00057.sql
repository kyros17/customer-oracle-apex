...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(15691632414595641331)
,p_plug_name=>'Users'
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(15691632525722641331)
,p_name=>'Manage Users'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(15691632718779641344)
,p_db_column_name=>'ID'
,p_display_order=>1
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(15691632829554641346)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(15691632917826641346)
...
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
,p_rpt_named_lov=>wwv_flow_imp.id(15691943130112720668)
,p_rpt_show_filter_lov=>'1'
,p_use_as_row_header=>'N'
);
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(15691633035534641347)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(15691633119601641347)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(16005663324613460736)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(15691637119713642043)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(14746583533418019029)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(15691632414595641331)
,p_button_name=>'RESET'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(14816675143445016166)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(15829848228491115526)
...
wwv_flow_imp_page.create_page_computation(
 p_id=>wwv_flow_imp.id(14916985630818546052)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(1661305898371272904)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1661306282065272912)
,p_event_id=>wwv_flow_imp.id(1661305898371272904)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(15691632414595641331)
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1661306747551272913)
,p_event_id=>wwv_flow_imp.id(1661305898371272904)
,p_event_result=>'TRUE'
