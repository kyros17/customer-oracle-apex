...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(18136306392908978458)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(18136306944460978464)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(18136307215303978464)
,p_plug_name=>'Data Load Source'
,p_parent_plug_id=>wwv_flow_imp.id(18136306944460978464)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(18136315437115978482)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(18136425019807939242)
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(18136432528477944549)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(18136432823524944551)
,p_query_column_id=>1
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(18136433228361944553)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(18136433620724944554)
,p_query_column_id=>3
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(18136434701160991133)
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(18136437256992992948)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(18136438379531992953)
,p_query_column_id=>1
,p_column_alias=>'TYPE'
,p_column_display_sequence=>1
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(18136437521348992951)
,p_query_column_id=>2
,p_column_alias=>'DESCRIPTION'
,p_column_display_sequence=>2
,p_column_heading=>'Description'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(18136437963626992953)
,p_query_column_id=>3
,p_column_alias=>'STATUS'
,p_column_display_sequence=>3
,p_column_heading=>'Status'
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(18136439701732994112)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(18136439955286994114)
,p_query_column_id=>1
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(18136440328666994114)
,p_query_column_id=>2
,p_column_alias=>'DESCRIPTION'
,p_column_display_sequence=>2
,p_column_heading=>'Description'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(18136440714170994115)
,p_query_column_id=>3
,p_column_alias=>'STATUS'
,p_column_display_sequence=>3
,p_column_heading=>'Status'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(18136503171425015943)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(18136306392908978458)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(18136308089359978467)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(18136306944460978464)
,p_button_name=>'NEXT'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(18136307663361978465)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(18136321876724978489)
,p_branch_action=>'f?p=&APP_ID.:126:&SESSION.&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(18136308089359978467)
,p_branch_sequence=>10
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(18136308524366978468)
,p_name=>'P125_IMPORT_FROM'
,p_is_required=>true
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(18136307215303978464)
,p_item_default=>'PASTE'
,p_prompt=>'Import From'
,p_display_as=>'NATIVE_RADIOGROUP'
,p_named_lov=>'DATA_LOAD_OPTION'
,p_lov=>'.'||wwv_flow_imp.id(15687735628771724811)||'.'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(18136308836886978470)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(18136310225309978472)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(18136311180989978475)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(18136312084649978476)
...
,p_lov=>'.'||wwv_flow_imp.id(15687738129255724817)||'.'
,p_field_template=>wwv_flow_imp.id(14860554640423970001)
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'YES'
,p_escape_on_http_input=>'Y'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(18136312979843978477)
...
,p_lov=>'.'||wwv_flow_imp.id(18134782882166750733)||'.'
,p_field_template=>wwv_flow_imp.id(14860554640423970001)
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'YES'
,p_escape_on_http_input=>'Y'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(18136313819958978479)
...
,p_lov=>'.'||wwv_flow_imp.id(18134784492139750741)||'.'
,p_cHeight=>1
,p_field_template=>wwv_flow_imp.id(14860554640423970001)
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'YES'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(18136315089913978480)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(18136315911382978482)
,p_name=>'P125_CURRENCY'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(18136315437115978482)
,p_item_default=>'$'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(18136316864397978483)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(18136317746256978484)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(18136434956944991136)
,p_name=>'P125_SAMPLE_DATA'
,p_item_sequence=>110
,p_item_plug_id=>wwv_flow_imp.id(18136434701160991133)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(18146864894346088192)
...
wwv_flow_imp_page.create_page_computation(
 p_id=>wwv_flow_imp.id(18146866182279088205)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(18136309830969978471)
...
,p_when_button_pressed=>wwv_flow_imp.id(18136308089359978467)
,p_associated_item=>wwv_flow_imp.id(18136308836886978470)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(17923927504679560331)
...
,p_validation_condition_type=>'VAL_OF_ITEM_IN_COND_EQ_COND2'
,p_when_button_pressed=>wwv_flow_imp.id(18136308089359978467)
,p_associated_item=>wwv_flow_imp.id(18136315089913978480)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(18136318575252978484)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(18136319563151978486)
,p_event_id=>wwv_flow_imp.id(18136318575252978484)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(18136319064799978485)
,p_event_id=>wwv_flow_imp.id(18136318575252978484)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(18136319986561978486)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(18136320970558978488)
,p_event_id=>wwv_flow_imp.id(18136319986561978486)
,p_event_result=>'FALSE'
,p_action_sequence=>20
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_HIDE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(18136320413942978487)
,p_event_id=>wwv_flow_imp.id(18136319986561978486)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(18146866433598088208)
,p_event_id=>wwv_flow_imp.id(18136319986561978486)
,p_event_result=>'FALSE'
,p_action_sequence=>30
,p_execute_on_page_init=>'Y'
...
,p_affected_region_id=>wwv_flow_imp.id(18136425019807939242)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(18146866398380088207)
,p_event_id=>wwv_flow_imp.id(18136319986561978486)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(18146697492243028996)
,p_name=>'Set copy and paste textarea with sample data'
,p_event_sequence=>30
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(18136503171425015943)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(18146699313093029001)
,p_event_id=>wwv_flow_imp.id(18146697492243028996)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(18146697865422028999)
,p_event_id=>wwv_flow_imp.id(18146697492243028996)
,p_event_result=>'TRUE'
,p_action_sequence=>20
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(18146698818229029001)
,p_event_id=>wwv_flow_imp.id(18146697492243028996)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(18146699841101029001)
,p_event_id=>wwv_flow_imp.id(18146697492243028996)
,p_event_result=>'TRUE'
,p_action_sequence=>40
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(18146698391158029000)
,p_event_id=>wwv_flow_imp.id(18146697492243028996)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(18146864999337088193)
,p_name=>'set orig copy paste value and submit'
,p_event_sequence=>40
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(18136308089359978467)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(18146865065847088194)
,p_event_id=>wwv_flow_imp.id(18146864999337088193)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(18146865174964088195)
,p_event_id=>wwv_flow_imp.id(18146864999337088193)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(18146865222169088196)
,p_event_id=>wwv_flow_imp.id(18146864999337088193)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(18146866548918088209)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(18146866605735088210)
,p_event_id=>wwv_flow_imp.id(18146866548918088209)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(18136321447275978488)
...
,p_process_when_button_id=>wwv_flow_imp.id(18136308089359978467)
);
wwv_flow_imp.component_end;
end;
/
