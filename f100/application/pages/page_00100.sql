...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(486728580897274164)
...
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(486728666758274165)
,p_region_id=>wwv_flow_imp.id(486728580897274164)
,p_chart_type=>'bar'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(486728798720274166)
,p_chart_id=>wwv_flow_imp.id(486728666758274165)
,p_seq=>10
,p_name=>'Geography'
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(486728970791274168)
,p_chart_id=>wwv_flow_imp.id(486728666758274165)
,p_axis=>'y'
,p_is_rendered=>'on'
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(486728862342274167)
,p_chart_id=>wwv_flow_imp.id(486728666758274165)
,p_axis=>'x'
,p_is_rendered=>'on'
,p_format_scaling=>'auto'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(486729028061274169)
...
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(486729115020274170)
,p_region_id=>wwv_flow_imp.id(486729028061274169)
,p_chart_type=>'bar'
,p_animation_on_display=>'none'
,p_animation_on_data_change=>'none'
,p_orientation=>'vertical'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(486729253537274171)
,p_chart_id=>wwv_flow_imp.id(486729115020274170)
,p_seq=>10
,p_name=>'Geography'
,p_data_source_type=>'SQL'
,p_data_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(486729350567274172)
,p_chart_id=>wwv_flow_imp.id(486729115020274170)
,p_axis=>'x'
,p_is_rendered=>'on'
,p_format_scaling=>'auto'
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(486729444642274173)
,p_chart_id=>wwv_flow_imp.id(486729115020274170)
,p_axis=>'y'
,p_is_rendered=>'on'
,p_format_type=>'decimal'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(20248238217765958642)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(20248238536032958651)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(20248239794677958654)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(20248240918694958657)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(20248241353641958658)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(20248241733131958658)
,p_button_sequence=>1000
,p_button_plug_id=>wwv_flow_imp.id(20248241353641958658)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(20248238934524958651)
,p_name=>'P100_CATEGORY'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(20248238536032958651)
,p_item_default=>'0'
,p_prompt=>'Category'
,p_source=>'0'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(20248239350489958654)
,p_name=>'P100_GEO'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(20248238536032958651)
,p_prompt=>'Geography'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(20248244808561958669)
,p_name=>'cat'
,p_event_sequence=>10
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(20248246372871958670)
,p_event_id=>wwv_flow_imp.id(20248244808561958669)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(20248240918694958657)
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(20248246846871958670)
,p_event_id=>wwv_flow_imp.id(20248244808561958669)
,p_event_result=>'TRUE'
...
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(20248238217765958642)
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(20248242470271958664)
,p_name=>'geo'
,p_event_sequence=>20
,p_triggering_element_type=>'ITEM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(20248243957848958668)
,p_event_id=>wwv_flow_imp.id(20248242470271958664)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(20248244445702958669)
,p_event_id=>wwv_flow_imp.id(20248242470271958664)
,p_event_result=>'TRUE'
,p_action_sequence=>40
,p_execute_on_page_init=>'N'
