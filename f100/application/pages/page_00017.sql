...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(17794385142203982362)
...
,p_list_id=>wwv_flow_imp.id(17794384654861982346)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_imp.id(14860550880913969986)
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(17806887288402042902)
,p_plug_name=>'Reports'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(17806890386540055154)
...
,p_list_id=>wwv_flow_imp.id(17806888891950047223)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_imp.id(14860550880913969986)
);
wwv_flow_imp_page.create_page_computation(
 p_id=>wwv_flow_imp.id(17813688048107335118)
