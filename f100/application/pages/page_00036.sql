...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1657445141980039355)
,p_plug_name=>'Buttons'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(16348377844829143117)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(16348378644744143119)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(1657445141980039355)
,p_button_name=>'SAVE'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(16348378025998143118)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(16348378241847143119)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(16348378417523143119)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(16348378831647143120)
,p_name=>'P36_DISPLAY_SEQUENCE'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(16348377844829143117)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(16348379041875143122)
,p_name=>'P36_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(16348377844829143117)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(16348379226346143122)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(16348379427684143123)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(16348379629075143123)
...
,p_lov=>'.'||wwv_flow_imp.id(16348382327114143133)||'.'
,p_cHeight=>1
,p_field_template=>wwv_flow_imp.id(268059731360047957)
,p_item_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(16348380025457143124)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(16348380236574143124)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(16348381214678143129)
,p_validation_name=>'P36_DISPLAY_FROM must be timestamp'
,p_validation_sequence=>10
,p_validation=>'P36_DISPLAY_FROM'
,p_validation_type=>'ITEM_IS_TIMESTAMP'
,p_error_message=>'#LABEL# must be a valid timestamp.'
,p_associated_item=>wwv_flow_imp.id(16348380025457143124)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(16348381441907143129)
,p_validation_name=>'P36_DISPLAY_UNTIL must be timestamp'
,p_validation_sequence=>20
,p_validation=>'P36_DISPLAY_UNTIL'
,p_validation_type=>'ITEM_IS_TIMESTAMP'
,p_error_message=>'#LABEL# must be a valid timestamp.'
,p_associated_item=>wwv_flow_imp.id(16348380236574143124)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(14981220042543646630)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(1657445284412039356)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(16348378241847143119)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1657445401777039357)
,p_event_id=>wwv_flow_imp.id(1657445284412039356)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(16348381526188143129)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(16348381721304143131)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(16348381944628143131)
...
,p_attribute_04=>'31'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(16348378417523143119)
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(1657445452731039358)
