...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1657445888353039362)
,p_plug_name=>'Buttons'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(15830384541066385107)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(14874423330736319526)
,p_plug_name=>'Form Items'
,p_parent_plug_id=>wwv_flow_imp.id(15830384541066385107)
,p_region_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(16005403935648435470)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(1657445888353039362)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(15830384723477385109)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(15830384844327385109)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(15830385121323385110)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(15830384932720385109)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(15830385922075385113)
,p_name=>'P58_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(14874423330736319526)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(15830386137843385121)
,p_name=>'P58_USERNAME'
,p_is_required=>true
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(14874423330736319526)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(15830386521965385123)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(15979093025320549893)
...
wwv_flow_imp_page.create_page_computation(
 p_id=>wwv_flow_imp.id(14782256234252389212)
...
wwv_flow_imp_page.create_page_computation(
 p_id=>wwv_flow_imp.id(14916985824995548734)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(16602808640221742010)
...
,p_when_button_pressed=>wwv_flow_imp.id(15830384844327385109)
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
);
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(14916987125186579042)
...
,p_associated_item=>wwv_flow_imp.id(15830386137843385121)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(1657445682690039360)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(15830385121323385110)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1657445978833039363)
,p_event_id=>wwv_flow_imp.id(1657445682690039360)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(15830388530927385130)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(15830388723888385131)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(15830388931452385131)
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(15830384932720385109)
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(1657445604858039359)
