...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(14738611419516043284)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(14738612622384043286)
,p_plug_name=>'Buttons'
,p_region_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(14738611829640043286)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(14738612622384043286)
,p_button_name=>'SAVE'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(14738611631960043284)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(14738613244051043287)
,p_branch_action=>'f?p=&APP_ID.:settings:&SESSION.::&DEBUG.:::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(14738611829640043286)
,p_branch_sequence=>10
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(14738612024639043286)
,p_name=>'P28_APPLICATION_TITLE'
,p_is_required=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(14738611419516043284)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(18005747506641934310)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(335550391886469185)
,p_name=>'CNX'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(14738611631960043284)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(335550415972469186)
,p_event_id=>wwv_flow_imp.id(335550391886469185)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(14738612945867043287)
...
,p_process_when_button_id=>wwv_flow_imp.id(14738611829640043286)
